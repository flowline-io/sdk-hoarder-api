...
// checks if the BookmarksPostRequestOneOf2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BookmarksPostRequestOneOf2{}

// BookmarksPostRequestOneOf2 struct for BookmarksPostRequestOneOf2
type BookmarksPostRequestOneOf2 struct {
...
type _BookmarksPostRequestOneOf2 BookmarksPostRequestOneOf2
...
func NewBookmarksPostRequestOneOf2(type_ string, assetType string, assetId string) *BookmarksPostRequestOneOf2 {
	this := BookmarksPostRequestOneOf2{}
	this.Type = type_
...
func (o *BookmarksPostRequestOneOf2) SetFileNameNil() {
	o.FileName.Set(nil)
}
...
func (o *BookmarksPostRequestOneOf2) SetSourceUrlNil() {
	o.SourceUrl.Set(nil)
}
...
func (o BookmarksPostRequestOneOf2) MarshalJSON() ([]byte, error) {
...
func (o BookmarksPostRequestOneOf2) ToMap() (map[string]interface{}, error) {
...
func (o *BookmarksPostRequestOneOf2) UnmarshalJSON(data []byte) (err error) {
	...
	varBookmarksPostRequestOneOf2 := _BookmarksPostRequestOneOf2{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varBookmarksPostRequestOneOf2)

	if err != nil {
		return err
	}

	*o = BookmarksPostRequestOneOf2(varBookmarksPostRequestOneOf2)

	return err
}

type NullableBookmarksPostRequestOneOf2 struct {
	value *BookmarksPostRequestOneOf2
	isSet bool
}

func (v NullableBookmarksPostRequestOneOf2) Get() *BookmarksPostRequestOneOf2 {
	return v.value
}

func (v *NullableBookmarksPostRequestOneOf2) Set(val *BookmarksPostRequestOneOf2) {
	v.value = val
	v.isSet = true
}

func (v NullableBookmarksPostRequestOneOf2) IsSet() bool {
	return v.isSet
}

func (v *NullableBookmarksPostRequestOneOf2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBookmarksPostRequestOneOf2(val *BookmarksPostRequestOneOf2) *NullableBookmarksPostRequestOneOf2 {
	return &NullableBookmarksPostRequestOneOf2{value: val, isSet: true}
}

func (v NullableBookmarksPostRequestOneOf2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBookmarksPostRequestOneOf2) UnmarshalJSON(src []byte) error {
	v.isSet = true
